...
from modeling_outputs_skim import (
    BaseModelOutputWithPastAndCrossAttentionsWithSkim,
    BaseModelOutputWithPoolingAndCrossAttentionsWithSkim,
...
class BertEncoder(nn.Module):
    ...
    def forward(
        ...
        return BaseModelOutputWithPastAndCrossAttentionsWithSkim(
            last_hidden_state=hidden_states,
            past_key_values=next_decoder_cache,
            hidden_states=all_hidden_states,
            attentions=all_self_attentions,
            cross_attentions=all_cross_attentions,
            all_skim_mask=all_skim_mask,
        )
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        return BaseModelOutputWithPoolingAndCrossAttentionsWithSkim(
